...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/d8V9EAv7m6)
...
```sh
npx nx serve admin-layout
```

To create a production bundle:

```sh
npx nx build admin-layout
```

To see all available targets to run for a project, run:

```sh
npx nx show project admin-layout
```
